...
static int initialize(int use_gpu)
{
	...
	context = CECL_CREATE_CONTEXT_FROM_TYPE( ctxprop, CL_DEVICE_TYPE_GPU, NULL, NULL, NULL );
	if( !context ) { printf("ERROR: CECL_CREATE_CONTEXT_FROM_TYPE() failed\n"); return -1; }

	// create command queue
	cmd_queue = CECL_CREATE_COMMAND_QUEUE( context, device_id, 0, NULL );
