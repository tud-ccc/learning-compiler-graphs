...
// Parboil
#define MAX_POS 1
#define POS_PER_THREAD 1
#define THREADS_W 1
#define SEARCH_RANGE 1
#define CEIL_POS 1
#define MAX_POS_PADDED 1
#define THREADS_H 1
#define SEARCH_DIMENSION 1
#define KB 1

// Parboil
#define CUTOFF2_VAL 1
// #define CUTOFF_VAL 1
#define CEIL_CUTOFF_VAL 1
#define GRIDSIZE_VAL1 1
#define GRIDSIZE_VAL2 1
#define GRIDSIZE_VAL3 1
#define SIZE_XY_VAL 1
#define ONE_OVER_CUTOFF2_VAL 1
#define DYN_LOCAL_MEM_SIZE 1

// Rodinia
#define DEFAULT_ORDER_2 1
